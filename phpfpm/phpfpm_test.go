...
// https://github.com/liip-elearning/php-fpm_exporter/issues/10
...
// https://github.com/liip-elearning/php-fpm_exporter/issues/24
...
func TestParseURL(t *testing.T) {
	var uris = []struct {
		...
		{"unix:///tmp/php.sock;/status", []string{schemeUnix, "/tmp/php.sock", "/status"}, nil},
		{"unix:///tmp/php.sock", []string{schemeUnix, "/tmp/php.sock", ""}, nil},
	}
